...
namespace Fryday\Zend\Navigation\Page;
 ...
 */
abstract class AbstractPage extends \Zend\Navigation\Page\AbstractPage 
// AbstractContainer  // ToDo extends Zend\Navigation\Page\AbstractPage
{	
    /**
        ...
        if (isset($options['type'])) {
            ...
            if (is_string($type) && !empty($type)) {
                switch (strtolower($type)) {
                    case 'mvc':
                        $type = 'Fryday\Zend\Navigation\Page\Mvc';
                        break;
                    case 'uri':
                        $type = 'Fryday\Zend\Navigation\Page\Uri';
                        break;
                }
