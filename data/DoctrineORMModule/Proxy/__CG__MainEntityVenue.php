 ...
 */
class Venue extends \Main\Entity\Venue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'category', 'phone', 'website', 'email', 'profileImage', 'address', 'city', 'country');
        }
